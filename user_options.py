...
from pretty_table_data import create_daily_food_table, \
    create_weekly_food_table, create_remaining_calories_table, \
    food_options_table
    ...
    def user_options(self):
        ...
        match self.user_input:
            case '1':
                ...
                # insert today's date at start of list
                new_food.insert(0,
                                str(today_date))
                ...
                Calories(date=str(today_date), week=current_week,
                         data=foods_week_sheet) \
            ...
            case '2':
                ...
                # Fix food option to offer
                # create food option if no food is found
                if len(today_food_data) == 0:
                    print('No food data for today')
                else:
                    daily_calorie_target = CalorieTarget(
                        current_week, foods_week_sheet).get_daily_target()
            ...
            case '3':
                ...
                CalorieTarget(
                    week=current_week,
                    food_week_data=foods_week_sheet
                ).set_week_target()
            ...
            case '4':
                ...
                if today_calories == 0 or None:
                    ...
                    create_remaining_calories_table(today_calories,
                                                    calorie_target)
            ...
            case _:
                ...
                print(
                    "Invalid option, please choose an option from the menu "
