    ...
    def validate_data(self, values) -> bool:
        ...
        try:
            ...
            if int(self.calories) <= 0 or int(self.weight) < 0:
                raise ValueError("Calories and weight must be a positive number")

            # check if calories and  are less than 5000 and weight less than 1000
            if int(self.calories) > 5000 or int(self.weight) > 1000:
                raise ValueError("Calories and weight must be less than 5000 and 1000")
            ...
            elif len(self.food) < 1 or self.food.isnumeric() or len(self.food) > 20:
                raise ValueError("Food must not be empty and must be a character, \n"
